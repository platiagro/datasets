...
MOCKED_DATASET_PATH = "tests/mocked_dataset.csv"
...
class TestApi(TestCase):
    ...
    def test_create_dataset(self):
        ...
        files={ "file": ("dataset.csv", self.iris_file(), "multipart/form-data") }
        rv = TEST_CLIENT.post("/datasets", files=files)#data={"file": self.iris_file(),})
        result = rv.json()
        expected = {
            "columns": [
        ...
        rv = TEST_CLIENT.post("/datasets", data={"file": self.boston_file(),})
        result = rv.json()
        expected = {
            "columns": [
        ...
        rv = TEST_CLIENT.post("/datasets", data={"file": self.titanic_file(),})
        result = rv.json()
        expected = {
            "columns": [
        ...
        rv = TEST_CLIENT.post("/datasets", data={"file": self.iris_file(),})
        result = rv.json()
        expected = {
            "columns": [
                {"name": "col0", "featuretype": "DateTime"},
        ...
        rv = TEST_CLIENT.post("/datasets", data={"file": self.gif_file(),})
        result = rv.json()
        expected = {
            "filename": "image.gif",
        }
    ...
    def test_get_dataset(self):
        ...
        rv = TEST_CLIENT.get("/datasets/{name}?page=1&page_size=2")
        result = rv.json()
        expected = {
            "columns": [
                {"name": "col0", "featuretype": "DateTime"},
        ...
        rv = TEST_CLIENT.get("/datasets/{name}?page=1&page_size=3")
        result = rv.json()
        expected = {
            "columns": [
                {"name": "col0", "featuretype": "DateTime"},
        ...
        rv = TEST_CLIENT.get("/datasets/{name}?page=15&page_size=2")
        result = rv.json()
        ...
        rv = TEST_CLIENT.get(f"/datasets/{name}?page_size=-1")
        result = rv.json()
        expected = {
            "columns": [
                {"name": "col0", "featuretype": "DateTime"},
        ...
        rv = TEST_CLIENT.get(f"/datasets/{name}?page_size=-2")
        result = rv.json()
        expected = {
            "columns": [
                {"name": "col0", "featuretype": "DateTime"},
    ...
    def test_update_column(self):
        ...
        rv = TEST_CLIENT.post("/datasets", json={"file": self.iris_file(),})
        name = rv.json("name")
    ...
    def test_patch_dataset(self):
        rv = TEST_CLIENT.patch("/datasets/UNK", data={
        ...
        rv = TEST_CLIENT.patch(f"/datasets/{name}", data={
        ...
        result = rv.json()
        expected = {"message": "featuretypes must be the same length as the DataFrame columns"}
        self.assertDictEqual(expected, result)
        self.assertEqual(rv.status_code, 400)

        rv = TEST_CLIENT.patch(f"/datasets/{name}", data={
            "featuretypes": (BytesIO(b"Numerical\n" +
                                     b"Categorical\n" +
                                     b"DateTime\n" +
                                     b"Numerical\n" +
                                     b"Categorical\n" +
                                     b"DateTime"), "featuretypes.txt"),
        })
        result = rv.json()
        expected = {
            "columns": [
                ...
                {"name": "col2", "featuretype": "DateTime"},
                {"name": "col3", "featuretype": "Numerical"},

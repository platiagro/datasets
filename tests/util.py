...
PREDICT_FILE_COLUMNS = [
    ...
    {
        "name": "RFClassifier_predict_proba_Altera__es_discrepantes",
        "featuretype": "Categorical",
    },
    {
        "name": "RFClassifier_predict_proba_Levemente_Alterado",
        "featuretype": "Categorical",
    },
